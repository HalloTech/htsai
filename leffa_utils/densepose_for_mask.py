...
import numpy as np
import torch
from leffa_utils.densepose import add_densepose_config
...
class DensePose:
    ...
    def __init__(self, model_path="./checkpoints/densepose_", device="cuda"):
        ...
        self.predictor = DefaultPredictor(self.cfg)  # Respects DEVICE now
    ...
    def setup_config(self):
        ...
        cfg.MODEL.DEVICE = self.device # ✅ Set BEFORE freezing!
        cfg.freeze()
        return cfg
